...
public class JwtUtil {
    // 在 JwtUtil 中使用 @Value("${jwt.secret}") 注入 secretKey 时，实际上是从
    // application.properties 文件中读取配置项 jwt.secret 的值。这样做的好处是，你只需要在
    // application.properties 文件中修改密钥，而不是在代码中修改。
    @Value("${jwt.secret}")
